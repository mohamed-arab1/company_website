      ...
      <section className={`container mx-auto  flex  justify-center`}>
        ...
        >
          ...
          <div className="flex flex-col text-center jb">
            ...
            <Button onClick={()=> setShow(true)}  style={ rtl && "!bg-[#002f69] text-[#f5f4f4]  hover:!bg-[#f5f4f4] hover:!text-[#002f69] hover:!border-[#002f69]"}>
              Book Service
            </Button>
           {show && <PopUpModal onClose={()=> setShow(false)}/>} 
           {/* <PopUpModal/> */}
          </div>
        </div>
      </section>
